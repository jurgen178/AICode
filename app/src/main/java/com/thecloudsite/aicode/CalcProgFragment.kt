...
import com.thecloudsite.aicode.databinding.DialogCalcBinding
import com.thecloudsite.aicode.databinding.FragmentCalcProgBinding
...
//    throw RuntimeException("Test Crash") // Force a crash
    ...
    private fun runCodeDialog(name: String) {
        ...
        dialogBinding.calcCode.syntaxHighlightRules = listOf(
            ...
            // math op
            SyntaxHighlightRule(
                "(?i)((\\s|^)(sin|cos|tan|arcsin|arccos|arctan|sinh|cosh|tanh|arcsinh|arccosh|arctanh|ln|log|sq|sqrt|pow|per|perc|binom|erf|inv|abs|mod|int|round|round2|round4|frac|tostr|sum|size|var|getv|setv|getm|setm|pi|π|e|and|or|xor|not|solve|factorial|[!]))+(\\s|$)",
                "#B50000"
            ),
            // ()
            SyntaxHighlightRule(
    ...
    override fun onViewCreated(
        ...
        binding.calcF10.setOnTouchListener { view, event ->
            touchHelperFunction(
                view,
                event
            ); false
        ...
        binding.calcF11.setOnTouchListener { view, event ->
            touchHelperFunction(
                view,
                event
            ); false
        ...
        binding.calcF12.setOnTouchListener { view, event ->
            touchHelperFunction(
                view,
                event
            ); false
        ...
        binding.calcF13.setOnTouchListener { view, event ->
            touchHelperFunction(
                view,
                event
            ); false
        ...
        binding.calcF14.setOnTouchListener { view, event ->
            touchHelperFunction(
                view,
                event
            ); false
        ...
        binding.calcF15.setOnTouchListener { view, event ->
            touchHelperFunction(
                view,
                event
            ); false
        ...
        binding.calcF16.setOnTouchListener { view, event ->
            touchHelperFunction(
                view,
                event
            ); false
