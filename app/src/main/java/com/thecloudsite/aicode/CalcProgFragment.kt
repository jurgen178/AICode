...
//    throw RuntimeException("Test Crash") // Force a crash
  ...
  private fun runCodeDialog(name: String) {
    ...
    dialogBinding.calcCode.syntaxHighlightRules = listOf(
      ...
      // math op
      SyntaxHighlightRule(
        "(?i)((\\s|^)(sin|cos|tan|arcsin|arccos|arctan|sinh|cosh|tanh|arcsinh|arccosh|arctanh|ln|log|sq|sqrt|pow|per|perc|inv|abs|mod|int|round|round2|round4|frac|tostr|sum|var|pi|π|e|and|or|xor|not))+(\\s|$)",
        "#B50000"
      ),
      // ()
      SyntaxHighlightRule(
